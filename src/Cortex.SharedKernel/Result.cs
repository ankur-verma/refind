...
/// <summary>
/// A discriminated result type for returning success/failure without throwing exceptions.
/// Follows the Result pattern for cleaner error handling across layers.
/// </summary>
public class Result
{
